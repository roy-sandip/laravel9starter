...
<table>
		<tr>
			<td>
				<span style="font-size:10px;">Scan the QR Code to Track <br></span>
				<tcpdf method="write2DBarcode" params="{{$qrCode}}" />
			</td>
			<td style="text-align:center;">Copy</td>
			<td>
				<table>
				<tr>
					<td  style="font-size:30pt;text-align:center; border:1px solid #000;font-weight:bold;font-family: pdfacourier, times, helvetica;background-color: #eee;">
						{{$shipment->awb}}
					</td>
				</tr>	
				<tr>	
...
<img src="images/conditions.png" alt=""> <br>

<br><br><br><table>
			<tr>
				<td style="text-align:center;border-top:2px solid black;">Shipper Sign</td>
				<td></td>
				<td  style="text-align:center;border-top:2px solid black;">Authority</td>
			</tr>
		</table>
...
.left tr td {text-align:left;font-size:13px;}
...
.main_table {font-size:11px; padding:3px 0px;}

td {text-transform: capitalized; font-weight:normal}
