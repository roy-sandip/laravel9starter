...
<div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <x-message/>
                <form action="{{route('admin.shipments.store')}}" method="POST" autocomplete="false">
                    @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="agent_id" id="" class="form-control form-control-sm select2 @error('agent_id') is-invalid @enderror" data-placeholder="Select Agent" required>
                                                ...
                                                <option value="{{$item->id}}" @if(old('agent_id') == $item->id) selected @endif >{{$item->name}}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                         ...
                                         <td>
                                            <select name="service_id" id="" class="form-control form-control-sm select2 @error('service_id') is-invalid @enderror" data-placeholder="Select Service" required>
                                                ...
                                                <option value="{{$item->id}}" @if(old('service_id') == $item->id) selected @endif >{{$item->name}}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <input type="number" min="0" name="weight" step="any" class="form-control form-control-sm @error('weight') is-invalid @enderror" value="{{old('weight')}}" >
                            ...
                            <div class="card card-info border border-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-6">
                                            <input name="shipper[city]" type="text" class="form-control form-control-sm @error('shipper.city') is-invalid @enderror" placeholder="City" value="{{old('shipper.city', ($shipment->shipper->city ?? 'SYLHET'))}}">
                                        </div>
                                        <div class="col-6">
                                            <input name="shipper[zip]" type="text" class="form-control form-control-sm @error('shipper.zip') is-invalid @enderror" placeholder="Post Code" value="{{old('shipper.zip', ($shipment->shipper->zip ?? 3100))}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <input name="shipper[country]" type="text" class="form-control form-control-sm @error('shipper.country') is-invalid @enderror" placeholder="Country" value="{{old('shipper.country', ($shipment->shipper->country ?? 'BANGLADESH'))}}">
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <textarea name="description" id="" cols="30" rows="5" class="form-control form-control-sm @error('description') is-invalid @enderror">{{old('description')}}</textarea>
                        </div>
                            ...
                            <hr>
                             <div class="form-group row">
                                 ...
                                 <div class="input-group input-group-sm col-sm-10 col-md-8">
                                    <input type="number" name="billing[bill]" max="99999999" class="form-control form-control-sm @error('billing.bill') is-invalid @enderror totalBill billing" value="{{old('billing.bill')}}">
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="input-group input-group-sm col-sm-10 col-md-8">
                                    <input type="number" name="billing[paid]" max="99999999" class="form-control form-control-sm @error('billing.paid') is-invalid @enderror totalPaid billing" value="{{old('billing.paid')}}">
                                    <div class="input-group-append"><span class="input-group-text">Taka</span></div> 
                                 </div>
                             </div>
                            <!--  <div class="form-group row">
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="input-group input-group-sm col-sm-10 col-md-8">
                                    <input type="number" max="99999999" class="form-control form-control-sm totalDue" readonly>
                                    <div class="input-group-append">
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="input-group input-group-sm col-sm-10 col-md-8">
                                    <input type="text"  name="billing[comment]" max="190" class="form-control form-control-sm" value="{{old('billing.comment')}}">
                                 </div>
                             </div>
                        </div>
                        @endcan
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <input type="text" name="operator" class="form-control form-control-sm col-sm-8 @error('operator') is-invalid @enderror" value="{{old('operator')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 offset-md-1">
                            <div class="form-group row">
                                ...
                                <div class="input-group input-group-sm date col-sm-8" id="datetimepicker1" data-target-input="nearest">
                                     <input type="text" name="date" class="form-control form-control-sm datetimepicker-input @error('date') is-invalid @enderror" data-target="#datetimepicker1" value="{{old('date', date('M d Y'))}}" />
